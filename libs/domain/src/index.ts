...
export * from './session/session.props';
...
export * from './authors/author.repository.port';

export * from './comments/book-comment.props';
export * from './comments/book-comment.entity';
export * from './comments/book-comment.repository.port';

export * from './likes/book-like.props';
...
export * from './genres/genre.props';
export * from './genres/genre.entity';
export * from './genres/ genre.repository.port';
