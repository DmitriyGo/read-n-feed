...
export const EnvironmentValidationSchema = z.object({
  [ConfigKeys.NODE_ENV]: z.enum(['development', 'production']).default('development'),
  [ConfigKeys.PORT]: z.preprocess((a) => parseInt(a as string, 10) || 3001, z.number()),
  ...
  // Logging
  [ConfigKeys.PINO_LOG_LEVEL]: z.enum(['debug', 'info', 'warn', 'error']).default('info'),
});
